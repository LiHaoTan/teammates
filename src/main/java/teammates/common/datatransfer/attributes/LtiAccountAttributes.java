...
public class LtiAccountAttributes extends EntityAttributes<LtiAccount> {
    ...
    public static LtiAccountAttributes valueOf(LtiAccount ltiAccount) {
        return new LtiAccountAttributes(ltiAccount.getUserId(), ltiAccount.getRegkey(), ltiAccount.getGoogleId());
    }
